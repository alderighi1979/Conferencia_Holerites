...
def seed_eventos(db):
    """Popula a tabela Eventos com eventos comuns."""
    eventos = [
        {"codigo_evento": 1, "descricao": "Salário Base", "tipo": TipoEventoEnum.PROVENTO,
         "inss_mensal": IncidenciaEnum.SIM, "fgts_mensal": IncidenciaEnum.SIM, "irrf_mensal": IncidenciaEnum.SIM,
         "inss_13": IncidenciaEnum.SIM, "fgts_13": IncidenciaEnum.SIM, "irrf_13": IncidenciaEnum.SIM,
         "inss_ferias": IncidenciaEnum.SIM, "fgts_ferias": IncidenciaEnum.SIM, "irrf_ferias": IncidenciaEnum.SIM},
